...
/****** Object:  Database [AvaleoAnalytics_Staging_Clean]    Script Date: 11/25/2010 07:16:30 ******/
CREATE DATABASE [AvaleoAnalytics_Staging_Clean] ON  PRIMARY 
( NAME = N'AvaleoAnalytics_Staging_Clean', FILENAME = N'E:\SQL Data\AvaleoAnalytics_Staging_Clean.mdf' , SIZE = 3984128KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'AvaleoAnalytics_Staging_log_Clean', FILENAME = N'E:\SQL Logs\AvaleoAnalytics_Staging_log_Clean.ldf' , SIZE = 172864KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
