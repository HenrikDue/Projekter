...
GO
/****** Object:  StoredProcedure [dbo].[usp_PrepareAnalysisdata]    Script Date: 02/23/2011 14:03:16 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_PrepareAnalysisdata]
...
--set @version = (SELECT VERSION FROM AvaleoAnalytics_DW.dbo.VERSION WHERE VERSION=28)
--if @version is null
--begin
