...
GO
/****** Object:  StoredProcedure [dbo].[usp_PrepareAnalysisdata]    Script Date: 01/03/2011 12:54:04 ******/
SET ANSI_NULLS ON
GO
...
set @version = (SELECT VERSION FROM AvaleoAnalytics_DW.dbo.VERSION WHERE VERSION=20)
if @version is null
begin
