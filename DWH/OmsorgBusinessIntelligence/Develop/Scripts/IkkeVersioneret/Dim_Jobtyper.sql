...
/****** Object:  View [dbo].[Dim_jobtyper]    Script Date: 11/16/2010 08:22:50 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT     JOBID, JOBNAVN, KATEGORI, NIVEAU1, NIVEAU2, NIVEAU3, BESKRIVELSE, SLETTET_JOB, SKRIVEBESKYTTET, FALLES_SPROG_KAT_KODE, 
                      FALLES_SPROG_NIV1_KODE, FALLES_SPROG_NIV2_KODE, FALLES_SPROG_NIV3_KODE, SIDSTE_VITALE_AENDRING, PLEJETYPE, NORMTID2, 
                      NORMTID3, NORMTID4, FUNKKAT, PROCBESKR, MAXTID2, MAXTID3, MAXTID4, FALLES_SPROG_ART, PARAGRAF, NORMTID1, MAXTID1, BTP
FROM         JOBTYPER
