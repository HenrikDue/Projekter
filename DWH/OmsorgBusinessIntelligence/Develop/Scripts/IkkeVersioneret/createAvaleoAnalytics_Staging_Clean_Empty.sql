...
/****** Object:  Database [AvaleoAnalytics_Staging_Clean]    Script Date: 11/15/2010 14:21:56 ******/
CREATE DATABASE [AvaleoAnalytics_Staging_Clean] ON  PRIMARY 
( NAME = N'AvaleoAnalytics_Staging_Clean', FILENAME = N'E:\SQL Data\AvaleoAnalytics_Staging_Clean.mdf' , SIZE = 10272KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'AvaleoAnalytics_Staging_log_Clean', FILENAME = N'E:\SQL Logs\AvaleoAnalytics_Staging_log_Clean.ldf' , SIZE = 2744KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
