USE [master]
GO
/****** Object:  Database [AvaleoAnalytics_STA]    Script Date: 10/06/2015 18:35:10 ******/
CREATE DATABASE [AvaleoAnalytics_STA] ON  PRIMARY 
( NAME = N'AvaleoAnalytics_STA', FILENAME = N'c:\avaleoproj\data\AvaleoAnalytics_STA.mdf' , SIZE = 6000KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'AvaleoAnalytics_STA_log', FILENAME = N'c:\avaleoproj\log\AvaleoAnalytics_STA_Log.ldf' , SIZE = 6000KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET COMPATIBILITY_LEVEL = 100
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [AvaleoAnalytics_STA].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET ANSI_NULL_DEFAULT OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET ANSI_NULLS OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET ANSI_PADDING OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET ANSI_WARNINGS OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET ARITHABORT OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET AUTO_CLOSE OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET AUTO_CREATE_STATISTICS ON
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET AUTO_SHRINK OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET AUTO_UPDATE_STATISTICS ON
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET CURSOR_CLOSE_ON_COMMIT OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET CURSOR_DEFAULT  GLOBAL
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET CONCAT_NULL_YIELDS_NULL OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET NUMERIC_ROUNDABORT OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET QUOTED_IDENTIFIER OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET RECURSIVE_TRIGGERS OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET  DISABLE_BROKER
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET AUTO_UPDATE_STATISTICS_ASYNC OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET DATE_CORRELATION_OPTIMIZATION OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET TRUSTWORTHY OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET ALLOW_SNAPSHOT_ISOLATION OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET PARAMETERIZATION SIMPLE
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET READ_COMMITTED_SNAPSHOT OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET HONOR_BROKER_PRIORITY OFF
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET  READ_WRITE
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET RECOVERY SIMPLE
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET  MULTI_USER
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET PAGE_VERIFY CHECKSUM
GO
ALTER DATABASE [AvaleoAnalytics_STA] SET DB_CHAINING OFF
GO
